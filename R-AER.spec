...
Version  : 1.2.10
Release  : 60
URL      : https://cran.r-project.org/src/contrib/AER_1.2-10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/AER_1.2-10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655256894
